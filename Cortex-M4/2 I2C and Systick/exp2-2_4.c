...
void S800_GPIO_Init(void)
{
  ...
  GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_0);			//Set PF0 as Output pin
	...
	GPIOIntTypeSet(GPIO_PORTJ_BASE, GPIO_INT_PIN_0, GPIO_FALLING_EDGE); // interrupts when pressed (rising edge for released)
...
void GPIOJ_Handler(void)
{
	...
	idx = (idx + 1) & 3;
	systick_counter = times * periods[idx];
}
