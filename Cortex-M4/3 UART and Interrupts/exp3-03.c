...
void UART0_Handler(void)
{
  ...
  while(UARTCharsAvail(UART0_BASE))    											// Loop while there are characters in the receive FIFO.
  {
		...
		if ((uart_receive_char >= '0' && uart_receive_char <= '9') || (uart_receive_char >= 'A' && uart_receive_char <= 'Z') || uart_receive_char == '+' || uart_receive_char == '-')
			buffer [len++] = uart_receive_char;
...
void processCommand(int8_t* str)
{
	uint8_t month, immed;
	if (strlen(str) != 6)
		return;
	if (str[0] == 'J' && str[1] == 'A' && str[2] == 'N')
		month = 1;
	else if (str[0] == 'F' && str[1] == 'E' && str[2] == 'B')
		month = 2;
	else if (str[0] == 'M' && str[1] == 'A' && str[2] == 'R')
		month = 3;
	else if (str[0] == 'A' && str[1] == 'P' && str[2] == 'R')
		month = 4;
	else if (str[0] == 'M' && str[1] == 'A' && str[2] == 'Y')
		month = 5;
	else if (str[0] == 'J' && str[1] == 'U' && str[2] == 'N')
		month = 6;
	else if (str[0] == 'J' && str[1] == 'U' && str[2] == 'L')
		month = 7;
	else if (str[0] == 'A' && str[1] == 'U' && str[2] == 'G')
		month = 8;
	else if (str[0] == 'S' && str[1] == 'E' && str[2] == 'P')
		month = 9;
	else if (str[0] == 'O' && str[1] == 'C' && str[2] == 'T')
		month = 10;
	else if (str[0] == 'N' && str[1] == 'O' && str[2] == 'V')
		month = 11;
	else if (str[0] == 'D' && str[1] == 'E' && str[2] == 'C')
		month = 12;
	immed = (str [4] - '0') * 10 + (str[5] - '0');
	if (str[3] == '+')
		month += immed;
	else if (str[3] == '-')
		month -= immed;
	...
	if (month == 1)
		UARTStringPutNonBlocking("JAN");
	else if (month == 2)
		UARTStringPutNonBlocking("FEB");
	else if (month == 3)
		UARTStringPutNonBlocking("MAR");
	else if (month == 4)
		UARTStringPutNonBlocking("APR");
	else if (month == 5)
		UARTStringPutNonBlocking("MAY");
	else if (month == 6)
		UARTStringPutNonBlocking("JUN");
	else if (month == 7)
		UARTStringPutNonBlocking("JUL");
	else if (month == 8)
		UARTStringPutNonBlocking("AUG");
	else if (month == 9)
		UARTStringPutNonBlocking("SEP");
	else if (month == 10)
		UARTStringPutNonBlocking("OCT");
	else if (month == 11)
		UARTStringPutNonBlocking("NOV");
	else if (month == 12)
		UARTStringPutNonBlocking("DEC");
}
